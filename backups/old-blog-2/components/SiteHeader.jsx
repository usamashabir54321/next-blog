                ...
                <div className="top_panel_wrap_inner top_panel_inner_style_1 top_panel_position_above">
                    <div className="top_panel_middle">
                        ...
                        <div className="columns_wrap columns_fluid">
                            <div className="column-1_5 contact_logo">
                                <div className="logo">
                                    {/* logo */}
                                    <Link href="/">
                            ...
                            <div className="column-3_5 contact_logo">
                                <nav role="navigation" className="menu_main_nav_area">
                                    <ul id="menu_main" className="menu_main_nav inited sf-js-enabled sf-arrows">
                                        <li id="menu-item-869" className="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-869">
                                            <a href="https://kidsplanet.ancorathemes.com/#" className="sf-with-ul">ہوم پیج</a>
                                        </li>
                                        <li id="menu-item-1149" className="menu-item menu-item-type-custom menu-item-1149">
                                            <Link href="/magazines" className="sf-with-ul">شمارے</Link>
                                        </li>
                                        <li id="menu-item-33" className="menu-item menu-item-type-post_type menu-item-33"><a href="https://kidsplanet.ancorathemes.com/about-us/">بارے میں</a></li>
                                        <li id="menu-item-849" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-849">
                                        ...
                                        <li id="menu-item-43" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-43">
                                            <a href="https://kidsplanet.ancorathemes.com/services/">خدمات</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
